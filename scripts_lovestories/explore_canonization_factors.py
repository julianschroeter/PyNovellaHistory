...
whole_df["lin_susp_model"] = whole_df.apply(lambda x: x.max_value + (0.725 * x.embedding_Angstempfinden), axis=1)
whole_df["fear_love"] = whole_df.apply(lambda x: x.Liebe * x.embedding_Angstempfinden, axis=1)
...
y_variables = ["Farben", "Abstrakta", "Hardseeds", "fear_love", "Liebe", "max_value", "embedding_Angstempfinden",  "lin_susp_model"]
...
for y_variable in y_variables:
    ...
    plt.title("Zeitliche Zu- und Abnahme von Spannung nach Kanonisierung")
