...
dtm_outfile_path = os.path.join(global_corpus_raw_dtm_directory(system), "dtm_lemma_tfidf10000semantic_periods100a.csv")
...
metadata_df_periods = years_to_periods(input_df=pd.read_csv(filepath_or_buffer=metadata_filepath, index_col=0), category_name="Jahr_ED",
