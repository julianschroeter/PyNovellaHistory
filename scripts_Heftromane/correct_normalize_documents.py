...
outfile_path = os.path.join(local_temp_directory(system), "hochlit_gegen_heftrom_normalized_corr")
...
generate_text_files(corpus_path=corpus_path, only_selected_files=False,  outfile_path=outfile_path,correct_ocr=True,
                    eliminate_pagecounts=True, handle_special_characters=True,
                  inverse_translate_umlaute=False, lemmatize=False,
                    reduce_to_words_from_list=True, reduction_word_list=german_words_list,
                  ...
                  eliminate_pos_items=False, list_eliminate_pos_tags=None,
                    keep_pos_items=False, list_keep_pos_tags=list_keep_pos_tags, remove_stopwords=False,
