...
for filepath in os.listdir(vocab_lists_dicts_directory(system)):
    if "Ausgangsliste_Spuk.txt" in filepath:
...
outfile_path = os.path.join(global_corpus_representation_directory(system), "Spuk_DocThemesMatrix_novellas_episodes.csv")
