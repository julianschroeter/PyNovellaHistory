...
dtm_obj.data_matrix_df = dtm_obj.data_matrix_df.drop(["00475-00", "00349-00", "00490-00", "00580-00", "00665-00"]) # remove Dubletten and texts that are intentionally represented twice in the corpus
...
for i in range(20):
    ...
    for pair in combinations(list_of_periods_dfs,2):
        ...
        if abs(start_b - start_a) >= 40:
            ...
            list_of_nearest_precursors.append(distances["instance_of_df1_with_min_dist_to_df2_group"][0][0])
