...
for x_variable in x_variables:
    ...
    fig, ax = plt.subplots()
    plt.scatter(df.loc[:, x_variable], df.loc[:, y_variable], color=authors_colors_list) # genre_colors_list
    ...
    ax.legend(handles=authors_mpatches_list) # genres_mpatches_list
