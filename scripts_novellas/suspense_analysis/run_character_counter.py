...
corpus_path = os.path.join(local_temp_directory(system), "Namen_novellas_chunks")
...
df.to_csv(os.path.join(local_temp_directory(system), "DocNamesCounterMatrix_novellas.csv"))
