...
list_of_real_genres_dfs = ["Novellenschatz", "sonstige MLP"]
...
replace_dict = {class_cat: {"TRUE": "Novellenschatz", "0": "sonstige MLP", "FALSE": "sonstige MLP", np.nan:"sonstige MLP"}}
...
p_to_df1, F_to_df1, p_to_df2, F_to_df2 = rd_iterate_intra_tests(n, df,
                                                                ...
                                                                sample_size_df=50)
print("average over n samples: Nov-Sch vs. non-Nov-Sch, sign. MannWhitneyU Test, test-statistic, p-value: ")
...
print("average over n samples: Nov-Sch vs Rest sign. MannWhitneyU Test, test-statistic, p-value: ")
print(np.array(F_to_df1).mean(), np.array(p_to_df1).mean())
print(" average over n samples: rest vs NovSch sign. MannWhitneyU Test, test-statistic, p-value: ")
