...
dtm_obj.data_matrix_df = years_to_periods(dtm_obj.data_matrix_df,category_name=year_cat, start_year=1790, end_year=1950, epoch_length=20,
...
for pair in combinations(list_of_periods_dfs,2):
    ...
    if abs(start_b - start_a) >= 40:
        ...
        print(metatdata_df.loc[distances["instance_of_df1_with_min_dist_to_df2_group"][0][0],["Nachname", "Titel", "Jahr_ED"]])