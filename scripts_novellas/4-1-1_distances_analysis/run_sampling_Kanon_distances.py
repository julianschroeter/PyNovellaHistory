...
outfile_csv_path = str(n) + "_" + metric + "_distances_one-author_Kanon_" + filename
outfile_dict_txt_path = str(n) + "_" + metric + "_distances_Kanon_" + filename_base + ".txt"
...
replace_dict = {class_cat: {3: "Kanon-Novelle", 2: "überlieferte MLP", 1: "sonstige MLP", 0: "sonstige MLP"}}
...
label_list = ["Kanon-Novelle", "überlieferte MLP" ,"sonstige MLP"]
...
df_ueberl = genre_dtm_obj.data_matrix_df
list_of_genre_dfs.append([label_list[1], df_ueberl])

genre_dtm_obj = dtm_obj.reduce_to_categories(metadata_category=class_cat, label_list=[label_list[2]])
df_other = genre_dtm_obj.data_matrix_df
list_of_genre_dfs.append([label_list[2], df_other])
