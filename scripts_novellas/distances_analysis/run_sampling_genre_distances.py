...
from preprocessing.distances import DistResults, GroupDistances
...
outfile_csv_path = str(n) + "_" + metric + "_distances_one-author_" + filename
...
list_of_genre_dfs.append([label_list[4], df_0E])
