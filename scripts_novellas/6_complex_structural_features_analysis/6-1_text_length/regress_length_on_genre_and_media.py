...
lm = ols('token_count ~ C(Medientyp_ED, Sum) + C(Gattungslabel_ED_normalisiert, Sum) + C(periods, Sum)',
                 data=data).fit()
...
lm = ols('token_count ~ C(periods, Sum)',
                 data=data).fit()
...
lm = ols('token_count ~ C(Gattungslabel_ED_normalisiert, Sum) + C(periods, Sum)',
                 data=data).fit()
print("Model 1.b without interaction, including time and media:")
lm = ols('token_count ~ C(Medientyp_ED, Sum) + C(periods, Sum)',
                 data=data).fit()
