...
df.rename(columns={"rom_top": "dep_var"}, inplace=True)
...
df = years_to_periods(input_df=df, category_name="Jahr_ED", start_year=1790, end_year=1910, epoch_length=20,
...
for period in periods20a:
    ...
    data = df_period.loc[:, (dep_var,genre_cat,medium_cat, "periods")]
