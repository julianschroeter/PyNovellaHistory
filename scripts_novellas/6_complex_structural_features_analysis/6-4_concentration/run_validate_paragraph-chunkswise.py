...
filename = "Networkdata_document_Matrix_paragraph-chunks.csv" # "SNA_novellas.csv"
...
df.to_csv(os.path.join(global_corpus_representation_directory(system), "Network_Matrix_paragraph-chunks.csv"))
