...
dtm_obj.data_matrix_df = dtm_obj.data_matrix_df[dtm_obj.data_matrix_df["periods"] == "1850-1950"]
...
df_0XE_E_Rundsch.loc[:,genre_cat] = "Rundschau-MLP+Erzählung"
list_of_genre_dfs.append(["Rundschau-MLP+Erzählung", df_0XE_E_Rundsch])
...
list_of_med_dep_df = [dfs_list[1] for dfs_list in list_of_genre_dfs if dfs_list[0] in ["Anthologie-Erzählung", "Anthologie-Novelle", "Anthologie-MLP",
                                                                                       "Familienblatt-Novelle", "Familienblatt-Erzählung", "Familienblatt-MLP",
                                                                                       "Rundschau-Novelle", "Rundschau-MLP+Erzählung"] ]
...
plt.savefig(os.path.join(local_temp_directory(system), "PCA_med_dep_after1850.png"))