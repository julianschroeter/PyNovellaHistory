...
colors_list = ["red", "green", "blue", "orange", "cyan", "yellow", "black", "magenta"]
...
replace_dict = {"Gattungslabel_ED_normalisiert": {"N": "Novelle", "E": "Erzählprosa", "0E": "Erzählprosa",
...
media_labels_list = ["Taschenbuch", "Anthologie"] #, "Familienblatt", "Rundschau", "Zeitschrift"
df = df[df.isin({"Medientyp_ED": media_labels_list}).any(1)]
