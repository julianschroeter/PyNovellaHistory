...
print(sample_df.sort_values(by="Marseille", ascending=False))
print(counter_sample_df.sort_values(by="Marseille", ascending=False))
...
# repeat the same validation procedure for the NE-POS based operationalization
...
print(sample_df.sort_values(by="rom_top", ascending=False))
print(counter_sample_df.sort_values(by="rom_top", ascending=False))
