...
for filename in os.listdir(global_corpus_raw_dtm_directory(system)):
    if filename == "raw_dtm_l1_lemmatized_use_idf_False2500mfw.csv": # alternative: "no-names_RFECV_red-to-515_LRM-R-N-E-0E-XEscaled_raw_dtm_lemmatized_l1__use_idf_False6000mfw.csv"
        ...
        for i in range(n):
            ...
            replace_dict = {
                "Gattungslabel_ED_normalisiert": {"N": "MLP", "E": "MLP",
                                                  "0E": "MLP",
                                                  "0R": "R", "0PE": "MLP",
                                                  "0X_Essay": "sonstige Journalinhalte",
                                                  "0PB": "sonstige Journalinhalte", "Lyrik": "sonstige Journalinhalte",
                                                  "Drama": "sonstige Journalinhalte",
                                                  "R": "R", "M": "Märchen",
                                                  "XE": "MLP",
                                                  "V": "sonstige Journalinhalte", "V ": "sonstige Journalinhalte",
                                                  "0P": "sonstige Journalinhalte", "0": "sonstige Journalinhalte"}}

            df = dtm_obj.data_matrix_df
            df = full_genre_labels(df, replace_dict=replace_dict)

            df_0 = df[df[genre_cat] == "MLP"]
...
plt.savefig("/home/julian/git/PyNovellaHistory/figures/gridsuche_c-at-one_MLP-R.svg")
plt.show()


outfile_output = os.path.join(local_temp_directory(system), "output_av_pred_probabs_MLP-R_n100.txt")
...
df.to_csv(path_or_buf=os.path.join(local_temp_directory(system), "av_pred_probabs_MLP-R_n100.csv"))
