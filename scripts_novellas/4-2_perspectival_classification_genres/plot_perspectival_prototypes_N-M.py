...
data_matrix_filepath = os.path.join(local_temp_directory(system), "av_pred_probabs_N-M_n100.csv")
...
legend_dict = {"Novelle": "red", "Märchen":"orange"}

outfile_path = "/home/julian/git/PyNovellaHistory/figures/prototype_circle_N-M.svg"
...
plt.savefig("/home/julian/git/PyNovellaHistory/figures/N-vs-M_temporal_perspectival.svg")
plt.savefig("/home/julian/git/PyNovellaHistory/figures/N-vs-M_temporal_perspectival.png")
plt.show()
