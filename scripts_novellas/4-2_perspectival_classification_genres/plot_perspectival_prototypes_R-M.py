...
outfile_output = os.path.join(local_temp_directory(system), "output_av_pred_probabs_R-M_n100.txt")
data_matrix_filepath = os.path.join(local_temp_directory(system), "av_pred_probabs_R-M_n100.csv")
...
legend_dict = {"Märchen": "orange", "Roman":"blue"}

outfile_path = "/home/julian/git/PyNovellaHistory/figures/prototype_circle_R-M.svg"
...
plt.savefig("/home/julian/git/PyNovellaHistory/figures/R-vs-M_temporal_perspectival.svg")
plt.savefig("/home/julian/git/PyNovellaHistory/figures/R-vs-M_temporal_perspectival.png")
plt.show()
