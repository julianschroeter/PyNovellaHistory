...
data_matrix_filepath = os.path.join(local_temp_directory(system), "av_pred_probabs_MLP-R_n100.csv")
...
legend_dict = {"MLP": "cyan", "Roman":"blue"}

outfile_path = "/home/julian/git/PyNovellaHistory/figures/prototype_circle_MLP-R.svg"
...
plt.savefig("/home/julian/git/PyNovellaHistory/figures/MLP-vs-R_temporal_perspectival.svg")
plt.savefig("/home/julian/git/PyNovellaHistory/figures/MLP-vs-R_temporal_perspectival.png")
plt.show()
