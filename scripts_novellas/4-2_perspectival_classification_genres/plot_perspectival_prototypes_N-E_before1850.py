...
plt.annotate("Arnim: Altdeutsche Landsleute", (df.loc["00292-00", periods_cat], df.loc["00292-00", "mean"]), arrowprops=dict(facecolor='black', shrink=0.05))
...
plt.savefig("/home/julian/git/PyNovellaHistory/figures/N-vs-E_before1850_perspectival.svg")
plt.savefig("/home/julian/git/PyNovellaHistory/figures/N-vs-E_before1850_perspectival.png")
plt.show()
