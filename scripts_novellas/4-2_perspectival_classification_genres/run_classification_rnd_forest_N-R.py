...
for filename in os.listdir(global_corpus_raw_dtm_directory(system)):
    if filename ==  "raw_dtm_l1_lemmatized_use_idf_False2500mfw.csv": # "no-names_RFECV_red-to-515_LRM-R-N-E-0E-XEscaled_raw_dtm_lemmatized_l1__use_idf_False6000mfw.csv":
        ...
        plt.title("Optimale Anzahl k Cluster: Novellen vs. Romane")
        ...
        plt.title("PCA mit Clustering der Novellen und Romane mit k-Means")
        plt.show()
        ...
        plt.title("PCA: Novellen und Romane")
        plt.show()
        ...
        plt.title("Vorhersagewahrscheinlichkeiten: Novelle vs. Roman")
        plt.show()
