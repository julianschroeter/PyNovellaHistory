...
for filename in os.listdir(global_corpus_raw_dtm_directory(system)):
    if filename ==  "raw_dtm_l1_lemmatized_use_idf_False2500mfw.csv": # "no-names_RFECV_red-to-515_LRM-R-N-E-0E-XEscaled_raw_dtm_lemmatized_l1__use_idf_False6000mfw.csv":
        ...
        subs_dict = {"N": 1, "E": 0, "XE":0, "0E":0}
        Y = list(map(subs_dict.get, Y_orig, Y_orig))

        subs_dict = {0: "cyan", 1: "red"}
        ...
        plt.title("Optimale Anzahl k Cluster: MLP")
        ...
        plt.title("PCA mit Clustering der Novellen und sonst. MLP mit k-Means")
        plt.show()

        legend_dict = {"Novelle": "red", "MLP": "cyan"}
        mpatches_list = []
