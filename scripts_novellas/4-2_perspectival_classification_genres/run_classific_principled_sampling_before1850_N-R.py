...
print(df)
df.to_csv(path_or_buf=os.path.join(local_temp_directory(system), "av_features_coefs_n100_N-E_before1850.csv"))
...
plt.savefig("/home/julian/git/PyNovellaHistory/figures/gridsuche_c-at-one_N-R.svg")
plt.show()


outfile_output = os.path.join(local_temp_directory(system), "output_av_pred_probabs_N-R-before1850_n100.txt")
...
df.to_csv(path_or_buf=os.path.join(local_temp_directory(system), "av_pred_probabs_N-R-before1850_n100.csv"))
