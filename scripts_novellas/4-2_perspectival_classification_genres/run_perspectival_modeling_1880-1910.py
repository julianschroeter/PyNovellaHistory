...
fit_period = ["1880-1910"] # ["1850-1950"]
transfer_period = ["1910-1940"] # ["1750-1850"]

fit_accuracy_scores_list, fit_f1scores_list, transfer_accuracy_scores_list, transfer_f1scores_list = LR_perspectival_resample(n=100, fit_val_size=0.3, input_df=input_df, period_category="periods30a", metadata_cat_fit_list=fit_period,
